      ...
      <div className="max-w-4xl mx-auto p-4 bg-white shadow-slate-400 shadow-xl rounded-xl text-black">
        ...
        <form className="space-y-6">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label htmlFor="expediente" className="block">No. De expediente:</label>
              <input type="text" id="expediente" className="w-full border p-2" />
              <p className="text-sm text-gray-500">(De uso exclusivo de la dirección de Investigación)</p>
            </div>
            <div>
              <p>Vo. Bo.</p>
              <input type="text" className="w-full border-b border-black mt-8" />
              <p>Aprobó</p>
              <input type="text" className="w-full border-b border-black mt-8" />
            </div>
          </section>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <input type="text" className="w-full border-b border-black mt-8" />
              <p>Nombre y Firma del director de la Licenciatura</p>
            </div>
            <div>
              <input type="text" className="w-full border-b border-black mt-8" />
              <p>Comité institucional de investigación.</p>
            </div>
          </section>
